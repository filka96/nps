...
\begin{document}
    ...
    Где:
    \begin{itemize}
        \item[npsw/] - директория приложения
        \item[npsw] - скрипт, запускающий приложение
        \item[Dockerfile] - скрипт, разворачивающий сервер
        \item[src/] - директория исходного кода приложения
        \item[app.R] - код, описывающий API
        \item[modules/] - директория, содержащая модули, соответствующие написанному API
        \item[module1/] - директория одного из модулей
        \item[server1.R] - файл, описывающий алгоритм модуля 'module1'
        \item[ui1.R] - функция, описывающая пользовательский интерфейс модуля 'module1'
        \item[util/] - директория, содержащая утилитарные функции
        \item[utilFunction1.R] - файл, описывающий утилитарную функцию
    \end{itemize}
